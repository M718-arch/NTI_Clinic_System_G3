...
use App\Http\Controllers\Api\Doctor\QueueController as DoctorQueueController;
use App\Http\Controllers\Api\Doctor\EmrController as DoctorEmrController;
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::prefix('doctor')->middleware('role:doctor')->group(function () {
        ...
        // EMR — Phase 8. Note: {patient} here is a Patient (route model
        // binding), not the doctor's own profile.
    ...
    Route::prefix('patient')->middleware('role:patient')->group(function () {
        ...
        // EMR & Prescriptions — Phase 8. Read-only; doctors create these.
    ...
    Route::prefix('receptionist')->middleware('role:receptionist')->group(function () {
        ...
        Route::patch('/appointments/{booking}/send-to-room', [ReceptionistAppointmentController::class, 'sendToRoom']);
